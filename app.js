...
app.get(routes.home, function(req, res){
    res.render('index.twig', new utils.injectGlobalData(globalData,{}));
});

app.get(routes.game, function(req, res){
    res.render('game.twig', new utils.injectGlobalData(globalData,{}));
});

app.get(routes.gameAI, function(req, res){
    res.render('gameAI.twig', new utils.injectGlobalData(globalData,{}));
});
